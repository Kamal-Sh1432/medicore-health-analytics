...
Translated leadership concerns into measurable KPIs

Defined business and functional requirements (BRD, FRD, SRS)

Designed and validated data models using SQL

Built executive-ready Power BI dashboards

Developed a predictive model to identify high-risk no-show appointments
...
Risk probabilities were translated into actionable categories, enabling:
...
Highlighted underutilized clinical capacity

Exposed patterns of revenue leakage
...
The company name “MediCore Health Services Pvt. Ltd.” is used for reference purposes only

All sensitive and identifiable information has been anonymized

Certain values have been masked where required, while preserving real business logic and analytical outcomes

The work presented reflects practical enterprise decision-making, not academic or hypothetical examples.
